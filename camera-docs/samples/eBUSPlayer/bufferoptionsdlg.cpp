...
void BufferOptionsDlg::accept()
{
    ...
    {
        QString lMessage;
        lMessage = QString("%1 GB of memory will be required by the acquisition pipeline. Are you sure you want to apply these settings?"
			).arg(lBufferOptions->GetRequiredMemoryInGB() );
